...
int main(int argc, char *argv[]) {
    ...
    string sBits = argv[1];
    string RUNTIMEFILE = "../experiments/runtimesBaseline/SEDBaselineClearComp/expSED-ClearComp"+sBits+".csv";
    string TEMPRUNTIMEFILE = "../experiments/runtimesBaseline/SEDBaselineClearComp/expSED-ClearComp-Template"+sBits+".csv";
    string PROBRUNTIMEFILE = "../experiments/runtimesBaseline/SEDBaselineClearComp/expSED-ClearComp-Probe"+sBits+".csv";
    ...
    for (int subject1 = 1; subject1 < SUBJECTS+1; subject1++) {
        ...
        TIC(runVerif);
        auto finalScoreCt = computeFinalScoreSEDBaseline(cryptoContext, subj1RefTempCt, subj1ProbeCT, oneAndZerosCT, NFEAT);
