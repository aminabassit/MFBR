...
int main(int argc, char *argv[]) {
    ...
    string sBits = argv[1];
    string RUNTIMEFILE = "../experiments/runtimesMFIP/MFIPClearComp/expMFIP-ClearComp"+sBits+".csv";
    string TEMPRUNTIMEFILE = "../experiments/runtimesMFIP/MFIPClearComp/expMFIP-ClearComp-Template"+sBits+".csv";
    string PROBRUNTIMEFILE = "../experiments/runtimesMFIP/MFIPClearComp/expMFIP-ClearComp-Probe"+sBits+".csv";
