...
int main(int argc, char *argv[]) {
    ...
    string sBits = argv[1];
    string RUNTIMEFILE = "../experiments/runtimesIPBoddeti/IPBoddetiEncComp/expIPBoddeti-EncComp"+sBits+".csv";
    string TEMPRUNTIMEFILE = "../experiments/IPBoddetiEncComp/expIPBoddeti-EncComp-Template"+sBits+".csv";
    string PROBRUNTIMEFILE = "../experiments/IPBoddetiEncComp/expIPBoddeti-EncComp-Probe"+sBits+".csv";
    ...
    for (int subject1 = 1; subject1 < SUBJECTS+1; subject1++) {
        ...
        */
        ...
        TIC(runVerif);
        auto finalScoreCt0 = computeFinalScoreIPBoddeti(cryptoContext, subj1RefTempCt, subj1ProbeCT, row_size);
        // The final score 'S' is already replicated over all plaintext slots in finalScoreCt0
        ...
        {
            auto finalScoreCT = cryptoContext->EvalAdd(finalScoreCt0, compVectTCs.at(i));
